...
const page = () => {
    ...
    return (
        <div className="project w-full px-4 sm:px-8 md:px-12 lg:px-20 py-6 relative">
            ...
            <FilterContainer projects={projects} setAllProjects={setAllProjects} setShowNotFound={setShowNotFound} />
            ...
            <div className="w-full py-6">
                ...
                {
                    showNotFound && (
                        <div className="p-10 shadow-lg shadow-gray-400 rounded-lg min-[500px]:w-[450px] mx-auto">
                            <p className="text-xl text-red-500 font-bold text-center mt-4">No project found with your selected options.</p>
                            <p className="text-gray-800 text-center mt-4">Please try with different options.</p>
                            <div className="flex justify-center mt-6">
                                <button 
                                    className="w-16 rounded-lg shadow-lg p-2 cursor-pointer bg-[#F3692A] text-white font-bold"
                                    onClick={() => setAllProjects(projects)}
                                >OK</button>
                            </div>
                        </div>
                    )
