...
const Testimonial = () => {
    return (
        <div className="w-full px-8 py-6 bg-[#135120]/8">
            <h2 className="text-3xl font-medium underline decoration-[#F3692A] decoration-4 underline-offset-8">Testimonial</h2>
            <div className="flex flex-col justify-center items-center my-8 gap-2">
                ...
                <div className="">
                    <p className="text-xl">MR JAMAN AND HIS FAMILY</p>
                    <p className="text-md text-[#6c6c6c]">Flat owner of Kaderia Palace, Lalbag, Dhaka</p>
                    <p className="text-xl pt-6 text-justify">We had a fantastic experience with ZB Engineering and Technology. From start to end, the whole process was very efficient and professional. Their construction quality is very good and they always adhere to their commitment. They helped us find the home we always desired for.</p>
                </div>
            </div>
