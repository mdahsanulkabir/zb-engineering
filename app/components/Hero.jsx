        ...
        <div className="relative w-full h-[640px]">
            ...
            <div className="absolute inset-0 pointer-events-none" style={{background: `linear-gradient(to right, rgba(17, 17, 17, 0.8) 10%, rgba(17, 17, 17, 0.8) 50%, rgba(17, 17, 17, 0) 88%)`}}>
                <div className="ml-8 mt-32">
                    ...
                    <p className="text-lg text-[#F7F7F7] pb-2 w-2/3">Lorem Ipsum is simply dummy text of the printing and type setting industry. </p>
                    <p className="text-lg text-[#F7F7F7] w-2/3">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled</p>
