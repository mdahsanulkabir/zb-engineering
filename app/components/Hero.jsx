        ...
        <div className="relative w-full h-[640px] sm:h-[640px] md:h-[650px] lg:h-[750px] xl:h-[780px]">
            ...
            >
                <div className="ml-4 sm:ml-8 md:ml-12 lg:ml-20 mt-30 md:mt-32 lg:mt-40">
                    ...
                    <p className={`text-base sm:text-lg md:text-xl text-[#F7F7F7] pb-2 w-3/5 transition-all duration-300 ease-out delay-200 ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                    >
                    ...
                    {/* <p
                        className={`text-base sm:text-lg md:text-xl text-[#F7F7F7] w-3/5 transition-all duration-300 ease-out delay-400 ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                    >
                    ...
                    <div className="flex  items-start sm:items-center gap-4 mt-10">
                        <button
                            ...
                            className={`bg-[#F3692A] text-white px-6 py-3 rounded-full hover:bg-orange-800 hover:text-white drop-shadow-lg drop-shadow-orange-900 hover:drop-shadow-gray-400 transition-all duration-300 ease-out delay-100 cursor-pointer ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                        >
                            Our Services
                        </button>
                        <button
                            onClick={() => handleNavigate('/projects')}
                            className={`bg-white px-6 py-3 rounded-full hover:bg-gray-400 hover:text-white drop-shadow-lg drop-shadow-gray-400 hover:drop-shadow-gray-800 transition-all duration-300 ease-out delay-100 cursor-pointer ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                        >
                            View Projects
                        </button>
                    </div>
