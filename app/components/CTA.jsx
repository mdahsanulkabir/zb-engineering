...
const CTA = () => {
    return (
        <div className="w-full px-8 py-6" style={{background: `linear-gradient(to right, rgba(88, 158, 89, 1) 0%, rgba(31, 56, 32, 1) 100%`}}>
            <div className="flex flex-col gap-4 items-center justify-evenly">
                <h2 className="text-2xl text-center font-medium text-[#F7F7F7]">Leading Way In Building & Civil Construction</h2>
                <ul className="text-[#F7F7F7]">
                    <li className="flex gap-3 font-bold items-center"><span className="text-[#FF7420] mt-1"><FaCheckCircle size={16}/></span>Professional Staff</li>
                    <li className="flex gap-3 font-bold items-center"><span className="text-[#FF7420] mt-1"><FaCheckCircle  size={16}/></span>100% Satisfaction</li>
                    <li className="flex gap-3 font-bold items-center"><span className="text-[#FF7420] mt-1"><FaCheckCircle  size={16}/></span>Accurate Testing</li>
                    <li className="flex gap-3 font-bold items-center"><span className="text-[#FF7420] mt-1"><FaCheckCircle  size={16}/></span>Transparent Pricing</li>
                </ul>
                <button className="rounded-full bg-[#FF7420] hover:bg-[#FF7420]/30 px-6 py-2 font-bold text-xl text-[#F7F7F7] hover:text-[hsl(24,87%,72%)] ring-2 ring-[#EBDBA5] shadow-2xl shadow-[#FF7420] hover:shadow-none hover:border-4">Contact us</button>
            </div>
        </div>
    );
    // return (
